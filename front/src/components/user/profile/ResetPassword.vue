...
<div class="bg-[#00000080]  fixed top-0 w-full h-screen">
    ...
    <div class="rounded mb-4 w-5/12 m-auto mt-28">
        <div class="form-header rounded-t-md bg-primary p-2 text-center text-white flex items-center justify-between">
            <p class="text-2xl text-center ">Change Password</p>
        ...
        <form class="p-5 bg-white rounded-b-md">
            ...
            <!-- <div  class="bg-red-300 rounded p-2 text-red-500">Enter your current password</div> -->
