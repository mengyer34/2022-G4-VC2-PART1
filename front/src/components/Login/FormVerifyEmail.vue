            ...
            <form class="p-5 bg-white rounded-b-md" @submit.prevent="confirmVerifyEmail" @keyup.enter="confirmVerifyEmail">
                ...
                <div class="mb-2 mt-2 relative">
                    ...
                    <input
                        ...
                        class="shadow appearance-none border border-gray-400 rounded w-full py-2 px-3 text-gray-700 focus:outline-primary focus:shadow-outline"   maxlength="6" type= "text" v-model="verify_code" placeholder="Verify code..">
                </div>
