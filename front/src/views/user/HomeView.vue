   ...
   <div>
     <div class="card w-8/12 m-auto mt-32 rounded-xl p-10 shadow- bg-white">
      ...
      <div class="footer pt-10 pl-3.5">
        <button id="btn_animated" class="bg-blue-100 items-center flex px-3 py-3 text-lg  rounded-md text-warning uppercase font-semibold " @click="showFormRequest">
            Ask Permission
